...
const GalleryPage: React.FC = () => {
    ...
    const videos = [
        { id: 1, title: 'Manifesto de Excelência', duration: '04:20', thumbnail: 'https://images.unsplash.com/photo-1492684223066-81342ee5ff30?auto=format&fit=crop&q=80&w=2070', src: '/assets/videos/manifesto.mp4' },
        { id: 2, title: 'Cerimônia de Abertura 2026', duration: '12:45', thumbnail: 'https://images.unsplash.com/photo-1505373877841-8d25f7d46678?auto=format&fit=crop&q=80&w=2012', src: '/assets/videos/ceremony.mp4' },
        { id: 3, title: 'Destaques Acadêmicos', duration: '08:15', thumbnail: 'https://images.unsplash.com/photo-1524178232363-1fb28f74b671?auto=format&fit=crop&q=80&w=2070', src: '/assets/videos/highlights.mp4' },
        { id: 4, title: 'Inovação e Gestão', duration: '06:30', thumbnail: 'https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?auto=format&fit=crop&q=80&w=2070', src: '/assets/videos/innovation.mp4' },
    ];
        ...
        <div className="w-full mesh-gradient-premium min-h-screen">
            <div className="max-w-7xl mx-auto px-6 py-32 animate-fade-in">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    {videos.map((video) => (
                        <div key={video.id} className="group relative cursor-pointer" onClick={() => setSelectedVideo({ src: video.src, title: video.title })}>
                            <div className="aspect-video rounded-[2.5rem] overflow-hidden glass-card p-2 border-white/5 transition-all duration-700 group-hover:scale-[1.02] group-hover:shadow-[0_40px_80px_rgba(0,0,0,0.6)]">
                                <div className="relative h-full w-full overflow-hidden rounded-[2.2rem]">
                                    ...
                                    <div className="absolute inset-0 flex items-center justify-center z-20">
                                        <div className="size-20 rounded-full bg-gold/10 backdrop-blur-2xl border border-gold/30 flex items-center justify-center group-hover:scale-125 transition-all duration-700 shadow-[0_0_40px_rgba(212,175,55,0.3)]">
                                    ...
                                    <div className="absolute bottom-8 left-10 right-10 z-20 flex items-end justify-between">
                                        ...
                                        <button className="text-off-white/60 hover:text-gold transition-colors" onClick={(e) => { e.stopPropagation(); /* handle share */ }}>
